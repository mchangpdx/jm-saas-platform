...
//  Zustand 세션 스토어를 초기화하고 마운트 시 selectedStoreId를 설정.
//  에이전시 사이드바는 전역 매장 선택 드롭다운을, 매장 사이드바는 매장명을 표시.
//  설정 링크는 실수 클릭 방지를 위해 메인 내비게이션(보안 아래)에 포함.
//  하단 섹션: 사용자 프로필 카드(아바타/이메일/역할 배지)와 두드러진 로그아웃 버튼.
//  충분한 여백으로 스크롤 가능한 내비와 고정된 하단 섹션 구분)
  ...
  return (
    ...
    <div className="flex h-full">
      ...
      <aside className="flex w-64 shrink-0 flex-col border-r border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
        ...
        <div className="flex flex-col gap-4 border-t border-gray-200 p-4 pb-8 dark:border-gray-800">
